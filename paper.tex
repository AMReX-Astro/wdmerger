...
\end{equation}\MarginPar{This result is derived in the freefall directory; I have edited the text to make it clear how I arrived at this result.}
...
\begin{figure}
  ...
  \caption{Solution to Sod's problem with the original reference state and the
    new reference state, as compared to the exact solution.  We note that the
    new reference state shows a slightly sharper shock and contact, but also has
    a dip at the tail of the rarefaction.}
  \label{Fig:sod}
\end{figure}
