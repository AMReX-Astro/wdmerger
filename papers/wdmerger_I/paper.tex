...
\begin{equation}
  \Phi_{{lmn}} = G\, \sum_{{i, j, k}} \frac{G \rho_{{ijk}}}{|\mathbf{x}_{{lmn}} - \mathbf{x}_{{ijk}}|}\, \Delta V_{{ijk}}.\label{direct_sum}
\end{equation} \MarginPar{should there really be 2 $G$'s?}
Here $(i, j, k)$ are the indices of cells inside the domain, and $(l,
m, n)$ \MarginPar{indices should be in normal math style, not roman}
