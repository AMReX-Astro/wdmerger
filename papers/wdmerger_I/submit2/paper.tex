...
Type Ia supernovae. To date there have been relatively few self-consistent simulations
of merging white dwarf systems using mesh-based hydrodynamics. This is the first
paper in a series describing simulations of these systems using a hydrodynamics
code with adaptive mesh refinement. In this paper we describe our numerical
methodology and discuss our implementation in the compressible hydrodynamics
code CASTRO, which solves the Euler equations, and the Poisson equation for
self-gravity, and couples the gravitational and rotation forces to the hydrodynamics.
Standard techniques for coupling gravitation and rotation forces to the hydrodynamics
do not adequately conserve the total energy of the system for our problem, but
recent advances in the literature allow progress and we discuss our implementation
here. We present a set of test problems demonstrating the extent to which our
software sufficiently models a system where large amounts of mass are advected
on the computational domain over long timescales. Future papers in this series
will describe our treatment of the initial conditions of these systems and will
examine the early phases of the merger to determine its viability for triggering
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.45]{bc_comparison}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.45]{phi_comparison}
...
\begin{figure}
  \centering
  \includegraphics[scale=0.4]{sponge}
...
\begin{figure}
  \centering
  \includegraphics[scale=0.45]{single_star_static_1e3_radius}
...
\begin{figure}
  \centering
  \includegraphics[scale=0.45]{single_star_static_ke}
...
\begin{figure}
  \centering
  \includegraphics[scale=0.45]{freefall}
...
\begin{figure*}[ht]
  ...
  \centering
  \includegraphics[trim=0.75in 0.45in 0.85in 0.5in, clip, scale = 0.75]{{{kh_t2.0_p2_low_res_collage}}}
...
\begin{figure*}[ht]
  \centering
  \includegraphics[trim=0.75in 0.45in 0.85in 0.5in, clip, scale = 0.75]{{{kh_t2.0_p3_low_res_collage}}}
  \caption{2D Kelvin-Helmholtz instability test at $t = 2.0$ for the initial 
    conditions given by \autoref{eq:kh_p3_rho} through \autoref{eq:kh_p3_vy},
    \textbf{which come from McNally et al. (2012)}.
...
\begin{figure*}[ht]
  \includegraphics[trim = 0in 1.25in 0.25in 1.25in, clip, scale=0.65]{{{kh_p3_high_res_collage}}}
...
spatial resolution to compensate for the increased numerical diffusion. \textbf{The 
...
\begin{figure}
  \centering
  \includegraphics[scale=0.45]{single_star_compare_1e3_radius}
...
\begin{figure}
  \centering
  \includegraphics[scale=0.45]{gravity_bcs}
...
\begin{figure*}
  \centering
  \includegraphics[scale=0.7]{circular_orbit_comparison}
...
\begin{figure}
  \centering
  \includegraphics[scale=0.45]{equal_energy_rot0}
...
\begin{figure}
  \centering
  \includegraphics[scale=0.45]{unequal_angular_momentum_rot1}
...
\begin{figure}
  \centering
  \includegraphics[scale=0.45]{unequal_gw_rot0}
...
we have achieved convergent behavior. \textbf{In the rotating frame, the results also show
...
\begin{figure}
  \centering
  \includegraphics[scale=0.45]{spatial_convergence_rot0}
  \caption{Distance between the two white dwarfs in the unequal mass system, for the first orbit.
...
\begin{figure}
  \centering
  \includegraphics[scale=0.45]{spatial_convergence_rot1}
  \caption{Distance between the two white dwarfs in the unequal mass system, for the first orbit.
           The distance is scaled by the initial orbital distance. 
           We plot at three different resolutions, corresponding to the number of 
           effective zones per dimension in the refined regions.
...
\begin{figure}
  \centering
  \includegraphics[scale=0.4]{weak_scaling}
...
the simulation time required is slightly \textbf{less} than 1.5 times the amount
...
\begin{figure}
  \centering
  \includegraphics[scale=0.4]{strong_scaling}
...
The authors thank John Bell, \textbf{Volker Springel, and Dominic Marcello}
for helpful discussions on gravity 
...
\software{BoxLib (\url{https://github.com/BoxLib-Codes/BoxLib}),
          CASTRO (\citet{castro}, \url{https://github.com/BoxLib-Codes/Castro}),
          wdmerger (\url{https://github.com/BoxLib-Codes/wdmerger}),
          GCC (\url{https://gcc.gnu.org/}),
          python (\url{https://www.python.org/}),
          matplotlib (\citet{matplotlib}, \url{http://matplotlib.org/}),
          yt (\citet{yt}, \url{http://yt-project.org/})}
