...
\texttt{aprox13}. \replaced{The results we describe below do not strongly depend on the network.}
{We have tried with a few (relatively small) networks, and the results we describe below hold
for all the ones we tested.}
