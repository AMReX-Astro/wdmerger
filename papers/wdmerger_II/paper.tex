...
the original versions of the networks mentioned above. Previous work using the \amrex\
...
As mentioned in \autoref{sec:hydrocoupling}, the ability to reject
...
\section{Hydrodynamics Algorithm Updates}
\label{app:hydro}

The core \castro\ algorithm for hydrodynamic evolution is presented in
\citet{wdmergerI}, and is largely unchanged in the present work. This appendix
focuses on minor revisions to the algorithm that have occurred since then.
