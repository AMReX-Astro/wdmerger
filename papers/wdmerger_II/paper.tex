...
spurious detonation. This seems to be equivalent to the method used in \citet{kushnir:2013}. Yet
we do not reproduce their claim that this fix is sufficient to ensure that the detonation occurs
at the proper and time and place; indeed, the burning is quenched until very late in the collision,
and the detonation barely forms at all. The suppression used therefore seems to be far too strong
to permit an actual detonation when one should occur. We have also checked the same method at higher
resolution and found that the nickel produced is significantly smaller than for a self-heating
calculation at the same resolution.
