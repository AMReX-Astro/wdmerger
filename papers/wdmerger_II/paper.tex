...
modifies the evolution for modest resolution simulations. The low amount of nickel generated is,
interestingly, similar to the results at higher resolution from \autoref{sec:resolution}. However,
this may be a coincidence rather than, as claimed by \citeauthor{kushnir:2013}, a shortcut to obtaining
a resolved simulation. In any case, the suppressed burn limiting used here is ultimately unphysical
and we choose not to use it in any other simulation.
