...
the results do not depend on this choice. A sponge is applied to all gas at a distance
greater than $2.5 \times 10^9$ cm from the origin, which is just larger than the
initial location of the outer edges of the white dwarfs. The sponge damps out the
velocity in this region (see Paper I) to prevent spurious numerical error from dragging
